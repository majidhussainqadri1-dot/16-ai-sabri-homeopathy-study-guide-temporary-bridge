...
Four corrective rounds are recorded in `FOUR-PLAN-AUDIT-2026-08-07.md`. Local release verification must include PHP syntax, JavaScript syntax, multilingual policy tests, output/secret gate tests, encryption round trip, four-plan positive and negative assertions, 19 FR/10 NFR trace presence, secret-pattern scan, deterministic double build, clean-extract retest and ZIP integrity/checksum.
