...
final class SCHA_Provider_Bridge implements SCHA_Provider_Interface {
    ...
    public function generate( array $request ): array|WP_Error {
        ...
        return array(
            'bridge'       => true,
            'bridge_url'   => $url,
            'answer'       => __( 'The temporary bridge opens an external Custom GPT in a new tab. It does not have native access to your platform account, private records, restricted corpus, or session history unless a future approved integration explicitly provides that access.', SCHA_TEXT_DOMAIN ),
            'provider'     => 'bridge',
