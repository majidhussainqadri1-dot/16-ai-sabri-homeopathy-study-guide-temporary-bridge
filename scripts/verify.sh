...
find "$ROOT/16-sabri-classical-homeopathy-ai" -name '*.php' -print0 | xargs -0 -n1 php -l >/dev/null
...
echo 'PASS: PHP, JavaScript, unit, adversarial, four-plan, package and secret checks'
